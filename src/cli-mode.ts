...
import {
  importAndCreateRuleInstances,
  getRuleModules,
} from "./util/ruleUtil.ts"; // Import the helper function
  ...
  try {
    ...
    const argv = await yargs(process.argv.slice(2))
      ...
      .option("logDiagnostic", {
        alias: "d",
        describe:
          "Sökväg till fill för diagnostiseringsinformation från  RAP-LP. Om en specificerad , så kommer diagnostiseringsinformationen att skrivas ut till stdout.",
        type: "string",
      }).argv;
